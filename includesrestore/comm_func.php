	...
	if($qry_noti->num_rows>0)
	{
		while($row = $qry_noti->fetch_assoc())
		{
			...
			if($fld_district_id!=0 && $aemail!=''){
				...
				$param = array('SiteID' => '30','fromAddress' => 'do_not_reply@nolaedu.net','fromName' => 'Synergy ITC','toAddress' => $aemail,'subject' => $subj, 'plainTex' => '','html' => $html_txt,'options' => '','groupID' => '805014','log' => 'True');
				$client->call('SendJangoMailTransactional', $param, '', '', false, true);
			}
