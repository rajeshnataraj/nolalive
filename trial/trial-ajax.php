<?php
	...
	if($oper == "createtrialuser" and $oper != '')
	{
		...
		$param = array('SiteID' => '30','fromAddress' => 'do_not_reply@nolaedu.net','fromName' => 'Synergy ITC','toAddress' => 'cparenti@nolaedu.net','subject' => 'New User registered - 30 days free trial', 'plainTex' => '','html' => $html_txt,'options' => '','groupID' => '805014','log' => 'True');
		$client = new nusoap_client(PAPI_URL . '/msgg/msgg.asmx?wsdl', 'wsdl');
		$client->call('SendJangoMailTransactional', $param, '', '', false, true);
		$param = array('SiteID' => '30','fromAddress' => 'do_not_reply@nolaedu.net','fromName' => 'Synergy ITC','toAddress' => 'ccampbell@nolaedu.net','subject' => 'New User registered - 30 days free trial', 'plainTex' => '','html' => $html_txt,'options' => '','groupID' => '805014','log' => 'True');
		$client = new nusoap_client(PAPI_URL . '/msgg/msgg.asmx?wsdl', 'wsdl');
		$client->call('SendJangoMailTransactional', $param, '', '', false, true);
	}
	...
	if($oper=="sendfeedback" and $oper != " " )
	{
		...
		if($qry->num_rows>0){
			...
			$param = array('SiteID' => '30','fromAddress' => 'do_not_reply@nolaedu.net','fromName' => 'Synergy ITC','toAddress' => 'sanjay@nanonino.com','subject' => $msubject, 'plainTex' => '','html' => $html_txt,'options' => '','groupID' => '805014','log' => 'True');
			$client = new nusoap_client(PAPI_URL . '/msgg/msgg.asmx?wsdl', 'wsdl');
			$client->call('SendJangoMailTransactional', $param, '', '', false, true);
			echo "success";
			//msparlin@nolaedu.net
		}
	}
