...
<section data-type='2home' id='library-modules'>
    ...
    <div class='container'>
        ...
        <div class='row buttons rowspacer' id="modulelist">
			...
			?>
            <a class='skip btn mainBtnLarge' style="width:210px;" href='http://robo-review.nolaedu.net' id='btnlibrary-modules-newmodule' onclick="window.open('http://robo-review.nolaedu.net');" name='0,0'>
            	<div class='icon-synergy-add-dark'></div>
