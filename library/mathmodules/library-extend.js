			...
			success: function(data) {
			  ...
			  if(type=='new' || type=='copy')
			  {
				...
				if(status=="sucess")
				{
				 ...
				 var Content3='</div><div class="delete-btn" onclick="deleteextendtext('+extendid+');" ></div><div onclick="showfullscreenmoduleextend(\'0,'+moduleid+','+moduleid+','+extendid+',1,'+userid+'\');" class="edit-btn"></div></div></td></tr>';
...
function showfullscreenmoduleextend(fldrname,type){
	...
	ifrpath = CONTENT_URL + '/moduleplay/mathmodplayerdemo.php';
