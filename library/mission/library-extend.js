			...
			success: function(data) {
			  ...
			  if(type=='new' || type=='copy')
			  {
				...
				if(status=="sucess")
				{
				 ...
				 var Content2='<td class="createnewtd"><div style="margin-left: 10px;" ><div class="view-btn mainBtn" name="'+expid+','+extendid+'" id="btnlibrary-mission-viewtaskmatlist"></div><div onclick="fn_showextendform(\''+enexpid+'\','+extendid+',\'rename\')" class="rename-btn"></div><div class="copy-btn" onclick="fn_showextendform(\''+enexpid+'\','+extendid+',\'copy\')">';
				 var Content3='</div><div class="delete-btn" onclick="deleteextendtext('+extendid+');" ></div><div class="edit-btn mainBtn" name="'+expid+','+extendid+','+userid+','+access+'" id="btnlibrary-mission-viewmateriallist"></div></div></td></tr>';
