...
<script language="javascript" type="text/javascript" src="../../js/growingautoinputtext.js"></script>
...
<?php
    ...
    <div class='row rowspacer'>
        <div class='twelve columns' id='qreview'>
            <?php echo $question; ?>
        </div>
    </div>
    <script>
     $("#qreview").find("a").attr("style","");
     $("#qreview").find("p").attr("style","");
     $("#qreview").find("span").attr("style","");
     $("#qreview").find("div").attr("style","");
     $("#qreview").find("table").attr("style","");
     $("#qreview").find("li").attr("style","");
     $("#qreview").find("ul").attr("style","");
     $("#qreview").find("h1").attr("style","");
     $("#qreview").find("h2").attr("style","");
     $("#qreview").find("h3").attr("style","");
     $("#qreview").find("h4").attr("style","");
     $("#qreview").find("h5").attr("style","");
     $("#qreview").find("h6").attr("style","");
     $("h1").addClass("hstyle");
     $("h2").addClass("hstyle");
     $("h3").addClass("hstyle");
     $("h4").addClass("hstyle");
    ...
    <div class='row rowspacer'>
        <div class='twelve columns'>
			...
			{
				$pullqus=$ObjDB->QueryObject("SELECT fld_answer AS answer
											FROM itc_question_answer_mapping
