...
if($oper == "register" and $oper != '')
{
	...
	$headers .= "From: do_not_reply@nolaedu.net" . "\r\n";
...
Synergy ITC account creation successful</h1><p>Hello <font style="font-style: italic;">'.$headtitle.':</font></p><p>Welcome to <font style="font-style: italic;">Synergy ITC</font>. Your account has been successfully created. Please log in to activate your account. Below you will find your login credentials along with a link to the <font style="font-style: italic;">Synergy ITC</font> login portal.</p><p><b>Username:</b> '.$usernamec.'</p><p><b>Password :</b>   '.$password.'</p><p><b>Access your <font style="font-style: italic;">Synergy ITC</font> account:</b><br><a href="'.__HOSTADDR__.'" target="_blank">'.__HOSTADDR__.'</a></p><p>If you have questions or difficulties logging in, please contact Customer Support at <br>800-526-5173. </p><p>Thank you,</p>
<p><strong>NOLA Education</strong><br>800-526-5173<br>www.nolaedu.net</p><p align="center"  style="font-style: italic;">Thank you for being a loyal Pitsco customer! <br>We appreciate all you do for students!</p>
</td></tr></tbody></table>';
