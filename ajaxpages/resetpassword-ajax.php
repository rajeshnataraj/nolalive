...
if($oper == "sentpasswordtoemail" and $oper != '') {
	...
	$html_txt = '<table cellpadding="0" cellspacing="0" border="0" width="98%"><tbody><tr><td style="padding:15px;font-family:Helvetica,Arial,sans-serif;font-size:16px;text-align:left"><img src="http://development.pitsco.info/images/pitsco-logo-n.png"/></td></tr><tr><td style="padding:15px;padding-top:10px;padding-bottom:40px;font-family:Helvetica,Arial,sans-serif;font-size:16px;color:#222222;text-align:left" valign="top"><h1 style="font-family:Helvetica,Arial,sans-serif;color:#222222;font-size:28px;line-height:normal;letter-spacing:-1px">Synergy ITC login credentials </h1><p>Hello '.$fname.',</p><p>Thank you for choosing Synergy ITC. We&lsquo;ve received a request for login information associated with the user name below.</p><p>If you continue to experience difficulties logging in, please contact Customer Support at 800-526-5173.</p><p><strong>User name: </strong>'.$uname.'</p><p><strong>Password: </strong> '.$encryptpass.'<br></p><hr style="margin-top:30px;border:none;border-top:1px solid #ccc"><p style="font-size:13px;line-height:1.3em"><b>Didn&lsquo;t ask to reset your password?</b><br><p>If you didn&lsquo;t ask for your password, it&lsquo;s possible that another user entered your user name or email address by mistake while trying to reset their password. If you have questions or concerns, please contact 800-526-5173.</p><p>Thank you,</p>
<p><strong>NOLA Education</strong><br>800-526-5173<br>www.nolaedu.net</p><p align="center"  style="font-style: italic;">Thank you for being a loyal Pitsco customer! <br>We appreciate all you do for students!</p></td></tr></tbody></table>';
