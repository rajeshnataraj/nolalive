...
{var _this=this;setInterval(function(){var d=new Date();var seconds=d.getSeconds();seconds=seconds<10?'0'+seconds:seconds;var month=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][d.getMonth()];var day=day<10?'0'+d.getDate():d.getDate();var weekday=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][d.getDay()];var today=weekday+' '+month+' '+day;jQuery(_this).find(".day").html(today)},1000)}})(jQuery);(function(e){e.idleTimer=function(t,i,d){d=e.extend({startImmediately:!0,idle:!1,enabled:!0,timeout:3e4,events:"mousemove keydown DOMMouseScroll mousewheel mousedown touchstart touchmove"},d),i=i||document;var l=e(i),a=l.data("idleTimerObj")||{},o=function(t){"number"==typeof t&&(t=void 0);var l=e.data(t||i,"idleTimerObj");l.idle=!l.idle;var a=+new Date-l.olddate;if(l.olddate=+new Date,l.idle&&d.timeout>a)return l.idle=!1,clearTimeout(e.idleTimer.tId),d.enabled&&(e.idleTimer.tId=setTimeout(o,d.timeout)),void 0;var m=e.Event(e.data(i,"idleTimer",l.idle?"idle":"active")+".idleTimer");e(i).trigger(m)},m=function(e){var t=e.data("idleTimerObj")||{};t.enabled=!1,clearTimeout(t.tId),e.off(".idleTimer")};if(a.olddate=a.olddate||+new Date,"number"==typeof t)d.timeout=t;else{if("destroy"===t)return m(l),this;if("getElapsedTime"===t)return+new Date-a.olddate}l.on(e.trim((d.events+" ").split(" ").join(".idleTimer ")),function(){var t=e.data(this,"idleTimerObj");clearTimeout(t.tId),t.enabled&&(t.idle&&o(this),t.tId=setTimeout(o,t.timeout))}),a.idle=d.idle,a.enabled=d.enabled,a.timeout=d.timeout,d.startImmediately&&(a.tId=setTimeout(o,a.timeout)),l.data("idleTimer","active"),l.data("idleTimerObj",a)},e.fn.idleTimer=function(t,i){return i||(i={}),this[0]&&e.idleTimer(t,this[0],i),this}})(jQuery);(function($){var Gumby=function(){var gumbyData={},setGumbyData=function(key,value){return gumbyData[key]=value},getGumbyData=function(key){return gumbyData[key]||!1},simpleUI={ui:[{selector:'.checkbox',onEvent:'click',className:'checked',target:!1,condition:!1,complete:function($e){var checked=$e.hasClass('checked');$e.children('input').attr('checked',checked)}},{selector:'.radio',onEvent:'click',className:'checked',target:!1,condition:!1,complete:function($e){var $input=$e.children('input'),$otherInputs=$('input[name="'+$input.attr('name')+'"]');$otherInputs.attr('checked',!1).parent().removeClass('checked');$input.attr('checked',!0).parent().addClass('checked')}},{selector:'form[data-form="validate"] .field',onEvent:'blur',className:'error',target:!1,condition:function($e){var $child=$e.find('input, textarea').first(),val=$child.val();if(!$child.attr('required')){return!1}
    if(($child.attr('type')==='email'&&!val.match(/^[\w.%&=+$#!-']+@[\w.-]+\.[a-zA-Z]{2,4}$/))||!val.length){$e.addClass('error');return!1}
    $e.removeClass('error')},complete:!1},{selector:'.toggle:not([data-on]), .toggle[data-on="click"]',onEvent:'click',className:'active',target:function($e){return $e.add($($e.attr('data-for')))},condition:!1,complete:!1},{selector:'.toggle[data-on="hover"]',onEvent:'mouseover mouseout',className:'active',target:function($e){return $e.add($($e.attr('data-for')))},condition:!1,complete:!1}],init:function(){var x,ui,$e,callBack,conditionalCallBack,activeClass,targetName;for(x in simpleUI.ui){ui=simpleUI.ui[x];$e=$(ui.selector);callBack=ui.complete&&typeof ui.complete==='function'?ui.complete:!1;conditionalCallBack=ui.condition&&typeof ui.condition==='function'?ui.condition:!1;targetName=ui.target&&typeof ui.target==='function'?ui.target:!1;activeClass=ui.className||!1;setGumbyData(ui.selector.replace(' ','-'),{'GumbyCallback':callBack,'GumbyConditionalCallBack':conditionalCallBack,'GumbyActiveClass':activeClass,'GumbyTarget':targetName});$(document).on(ui.onEvent,ui.selector,function(e){e.preventDefault();var $this=$(this),$target=$(this),gumbyData=getGumbyData(e.handleObj.selector.replace(' ','-')),condition=!0;if(gumbyData.GumbyConditionalCallBack){return condition=gumbyData.GumbyConditionalCallBack($this)}
    if(gumbyData.GumbyActiveClass){if(gumbyData.GumbyTarget){$target=gumbyData.GumbyTarget($this)}
        $target.toggleClass(gumbyData.GumbyActiveClass)}
    if(gumbyData.GumbyCallback){gumbyData.GumbyCallback($this)}})}}},complexUI={init:function(){complexUI.pickers();complexUI.skipLinks();complexUI.tabs()},pickers:function(){$(document).on('click','.picker',function(e){e.preventDefault();var $this=$(this),openTimer=null;if(window.getComputedStyle($this.get(0),':after').getPropertyValue('content')==='handheld'){return!1}
    $this.hover(function(){clearTimeout(openTimer)},function(){var $this=$(this);openTimer=setTimeout(function(){$this.removeClass('open')},500)});$this.toggleClass('open')});$(document).on('click','.picker > ul > li',function(e){e.preventDefault();var $this=$(this),$parent=$this.parents('.picker'),val=$this.children('a').html();$parent.children('.toggle').html(val+'<span class="caret"></span>');$parent.find('option').attr('selected',!1).eq($this.index()+1).attr('selected',!0)})},skipLinks:function(){var skip=function(){var skipTypeParts,skipType,$skipTos=$('[data-type]'),$skipTo=!1,onWin=!1,$this=$(this);if($this.get(0)===window&&!window.location.hash){return!1}
    if($this.get(0)===window&&window.location.hash){skipType=window.location.hash.replace('#','');onWin=!0}else{skipTypeParts=$this.attr('href').split('#');skipType=skipTypeParts[skipTypeParts.length-1]}
    $skipTos.each(function(){var typeParts=$(this).attr('data-type').split(' '),x;for(x in typeParts){if(typeParts[x]===skipType){$skipTo=$(this);return!1}}});if(!$skipTo.length){return!1}
    $('body,html').animate({'scrollTop':$skipTo.offset().top},350);if(onWin){window.location.hash=skipType}};$(document).on('click','.skiplink a, .skipnav ul li a, .skip',skip);$(window).load(skip)},tabs:function(){var activateTab=function($tab){var
    $tabs=$tab.parents('.tabs'),activeTab={'tab':$tabs.find('ul').children('li.active'),'content':$tabs.find('div[data-tab].active')},newTab={'tab':$tab.parent('li'),'content':$tabs.find('[data-tab='+$tab.attr('href').replace('#','')+']')},x,y;for(x in activeTab){activeTab[x].removeClass('active')}
    for(y in newTab){newTab[y].addClass('active')}}
    $(document).on('click','.tabs ul li a',function(e){activateTab($(this))});if(window.location.hash){var $activeTab=$('a[href="'+window.location.hash+'"]');if($activeTab.length&&$activeTab.parents('.tabs').length){activateTab($activeTab)}}}},init=function(){simpleUI.init();complexUI.init()};return{i:init}}().i()})(window.jQuery);var ajaxCurrentRequest=null;var ajaxcnt=0;window.log=function(){log.history=log.history||[];log.history.push(arguments);if(this.console){arguments.callee=arguments.callee.caller;var a=[].slice.call(arguments);(typeof console.log==="object"?log.apply.call(console.log,console,a):console.log.apply(console,a))}};(function(b){function c(){}
    for(var d="assert,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,log,timeStamp,profile,profileEnd,time,timeEnd,trace,warn".split(","),a;a=d.pop();){b[a]=b[a]||c}})((function(){try{console.log();return window.console}catch(err){return window.console={}}})());var currentRequest=null;$(document).ready(function(){jQuery.fn.ForceNumericOnly=function(){return this.each(function()
{$(this).keydown(function(e)
{var key=e.charCode||e.keyCode||0;return(key==8||key==9||key==46||key==190||key==110||(key>=37&&key<=40)||(key>=48&&key<=57)||(key>=96&&key<=105))})})};$.expr[":"].contains=$.expr.createPseudo(function(arg){return function(elem){return $(elem).text().toUpperCase().indexOf(arg.toUpperCase())>=0}});$('body').ajaxStart(function(){$(this).css({'cursor':'wait'})}).ajaxStop(function(){$(this).css({'cursor':'default'})}).ajaxError(function(event,jqxhr,settings,exception){if(exception!='abort'){}
    if(jqxhr.status==302)
    {window.location="index.php"}}).ajaxComplete(function(){$(".tipsy").remove();if(navigator.appName=='Microsoft Internet Explorer')
{$('.dim').attr('disabled',!0);$(".dim").prop('onclick',null);$(".dim").prop('click',null)}});$.ajaxSetup({cache:!1,error:function(jqXHR,textStatus,errorThrown){if(jqXHR.status==0&&ajaxcnt==0)
{ajaxCurrentRequest=this;$.fn.checknet();ajaxcnt++}}});function initialLoadOut(){$.ajax({url:"main-menu.php",beforeSend:function(){ajaxloadingalert('Loading, please wait.')},success:function(data){$('body').append(data);$("#home").effect("slide",{direction:"up",easing:"easeOutSine",duration:400});$("#home").css('z-index','899');ajaxclosingalert()},dataType:'html'})}
    initialLoadOut();$('.dash').click(function(){});$('.navUserIcon').focus(function(){this.blur()});$(document).delegate('.mainBtn','click',function(){$('.remarkContainer').remove();var upNext=$(this).attr('id');var id=$(this).attr('name');var thisSectionName="#"+$(this).closest('section[class!="black-overlay"]').attr("id");var folder=upNext.split("-");if(folder.length==1){upNextfolder=folder[0].substring(3)+"/"+upNext.substring(3)}
    else if(folder.length==2){upNextfolder=folder[0].substring(3)+"/"+folder[1]+"/"+upNext.substring(3)}
    else if(folder.length==3){upNextfolder=folder[0].substring(3)+"/"+folder[1]+"/"+upNext.substring(3)}
    else{upNextfolder=upNext.substring(3)}
        var currentSection="#"+upNext.substring(3);function bringIt(){currentRequest=$.ajax({url:upNextfolder+".php",data:"id="+id,type:'POST',beforeSend:function(){ajaxloadingalert('Loading, please wait.');if(currentRequest!=null)
        {currentRequest.abort()}},success:function(data){$(currentSection).remove();$('.ui-effects-wrapper').remove();$('body').append(data);pagetop();ajaxclosingalert();$(currentSection).addClass("blueWindow1").hide();var parentZ=[];$('section[class!="black-overlay"]').each(function(index,element){parentZ[index]=$(this).css('z-index')});$('section[class!="black-overlay"]').each(function(index,element){if(index>0){$(this).removeClass('blueWindow1').removeClass('blueWindow2');$(this).find('p:lt(2)').removeAttr('class');if(index%2==0){$(this).addClass('blueWindow1');$(this).find('p:lt(2)').each(function(index,element){if(index<=1){if(index==0){$(this).addClass('lightTitle')}
        else{$(this).addClass('lightSubTitle')}}})}
        else{$(this).addClass('blueWindow2');$(this).find('p:lt(2)').each(function(index,element){if(index<=1){if(index==0){$(this).addClass('darkTitle')}
        else{$(this).addClass('darkSubTitle')}}})}}});$(currentSection).effect("slide",{direction:"up",easing:"easeInOutSine",duration:250},function(){var scrtop=($(currentSection).offset().top-55)-$(window).scrollTop();$('html,body').animate({scrollTop:'+='+(scrtop)+'px'},'slow')});$('#'+upNext).removeClass("dim")},dataType:'html'})}
        $(thisSectionName).nextAll('section[class!="black-overlay"]').hide("fade").remove();bringIt()})});function fn_cancel(id)
{$('#'+id).nextAll('section').hide("fade").remove()}
function pagetop()
{var dataparam="oper=pagetop";$.ajax({type:'POST',url:'scroll.php',data:dataparam,success:function(ajaxdata){$('body').append(ajaxdata)}})}
var content_url="itccontent.nolaedu.net"
var cloudfront_url="cloudfront.nolaedu.net"
if(location.host=="localhost"){content_url="localhost"}
else{document.domain='nolaedu.net'}
function escapestr(str){return escape(str.replace(/<script[^>]*>([\s\S]*?)<\/script[^>]*>/,""))}
function search_list(listboxid,list){var filter=$(listboxid).val();if(filter){$(list).find("div[class^='dragItemLable']:not(:contains("+filter+"))").parent('div').slideUp();$(list).find("div[class^='dragItemLable']:contains("+filter+")").parent('div').slideDown()}else{$(list).find("div").slideDown()}}
function getPageName(url){var currurl=url;var index=currurl.lastIndexOf("/")+1;var filenameWithExtension=currurl.substr(index);var filename=filenameWithExtension.split(".")[0];return filename}
function showduallogin(){var dataparam="oper=dualloginform&";$.ajax({url:'duallogin-ajax.php',data:dataparam,cache:!1,type:"POST",beforeSend:function(){showloadingalert('Loading, please wait.')},success:function(data){$('.lb-content').html(data);$('.lb-content').css({'padding':'10px'})}})}
function fn_duallogin()
{if($("#frmduallogin").validate().form())
{var dataparam="oper=duallogin&username="+$('#dualusername').val()+"&password="+$('#dualpassword').val();$.ajax({type:"POST",url:'duallogin-ajax.php',data:dataparam,beforeSend:function()
{},success:function(data)
{if(data=='success')
{window.location="index.php"}
else{alert("Invalid username/password")}}})}}
var lightbox_overlay='<section style="display:none" class="black-overlay"><div class="alert-cotent"><img height="60" width="60" src="img/loadinggif.gif" ></img></div></section>';function ajaxloadingalert(alertmessage){var cssObjOuter={'height':250,'width':$('body').width()-20,'overflow':'hidden'};var cssObjInner={'margin-left':$(window).width()*.45,'margin-top':($(window).height())*.1};$('body').append(lightbox_overlay);$(".black-overlay").css(cssObjOuter);$(".alert-cotent").css(cssObjInner);$(".black-overlay").fadeIn();var scrtop=($('.black-overlay').offset().top)-$(window).scrollTop();$('html,body').stop().animate({scrollTop:'+='+(scrtop-450)+'px'},500)}
function ajaxclosingalert(){$(".black-overlay").delay(200).slideUp(400);setTimeout('$(".alert-cotent").remove();$(".black-overlay").remove();',300)}
function showloadingalert(msg)
{var loading_overlay='<section style="display:none" class="white-overlay"><div class="lb-content"></div></section>';$("body").css('overflow','hidden');var cssObjOuter={'width':$(window).width(),'height':$(window).height(),'overflow':'hidden','top':0,'left':0};var cssObjInner={'margin-left':$(window).width()*.40,'margin-top':($(window).height())*.4};$('body').append(loading_overlay);$(".white-overlay").css(cssObjOuter);$(".lb-content").css(cssObjInner);$(".white-overlay").fadeIn(200);$(".lb-content").html(msg)}
function closeloadingalert()
{$(".white-overlay").fadeOut(200);$("body").css('overflow','');setTimeout('$(".lb-content").remove();$(".white-overlay").remove();',200)}
function showpages(pagename,pagelink){var currentSection="#"+pagename;var pagelink=pagelink.split("?");$.ajax({url:pagelink[0],cache:!1,async:!1,type:"POST",data:pagelink[1],beforeSend:function(){if(pagelink[0].indexOf("assignment-sigmath-test")>=0){console.log("inside");ajaxloadingalert('Loading, please wait.')}},success:function(data){if(pagelink[0].indexOf("assignment-sigmath-test")>=0){ajaxclosingalert()}
    $('body').append(data);$(currentSection).addClass("blueWindow1").hide();var parentZ=[];$('section[class!="black-overlay"]').each(function(index,element){parentZ[index]=$(this).css('z-index')});$('section[class!="black-overlay"]').each(function(index,element){if(index>0){$(this).removeClass('blueWindow1').removeClass('blueWindow2');$(this).find('p:lt(2)').removeAttr('class');if(index%2==0){$(this).addClass('blueWindow1');$(this).find('p:lt(2)').each(function(index,element){if(index<=1){if(index==0){$(this).addClass('lightTitle')}
    else{$(this).addClass('lightSubTitle')}}})}
    else{$(this).addClass('blueWindow2');$(this).find('p:lt(2)').each(function(index,element){if(index<=1){if(index==0){$(this).addClass('darkTitle')}
    else{$(this).addClass('darkSubTitle')}}})}}});$(currentSection).effect("slide",{direction:"up",easing:"easeOutSine",duration:450},function(){var scrtop=($(currentSection).offset().top-55)-$(window).scrollTop();$('html,body').animate({scrollTop:'+='+(scrtop)+'px'},'slow')});var thisZ=parentZ-1;$(currentSection).css('z-index',thisZ)},dataType:'html'})}
function showpageswithpostmethod(pagename,pagelink,datas){var currentSection="#"+pagename;currentRequest=$.ajax({url:pagelink,cache:!1,async:!1,type:"POST",data:datas,beforeSend:function(){ajaxloadingalert('Loading, please wait.');if(currentRequest!=null)
{currentRequest.abort()}},success:function(data){$('body').append(data);ajaxclosingalert();$(currentSection).addClass("blueWindow1").hide();var parentZ=[];$('section[class!="black-overlay"]').each(function(index,element){parentZ[index]=$(this).css('z-index')});$('section[class!="black-overlay"]').each(function(index,element){if(index>0){$(this).removeClass('blueWindow1').removeClass('blueWindow2');$(this).find('p:lt(2)').removeAttr('class');if(index%2==0){$(this).addClass('blueWindow1');$(this).find('p:lt(2)').each(function(index,element){if(index<=1){if(index==0){$(this).addClass('lightTitle')}
else{$(this).addClass('lightSubTitle')}}})}
else{$(this).addClass('blueWindow2');$(this).find('p:lt(2)').each(function(index,element){if(index<=1){if(index==0){$(this).addClass('darkTitle')}
else{$(this).addClass('darkSubTitle')}}})}}});$(currentSection).effect("slide",{direction:"up",easing:"easeOutSine",duration:200},function(){var scrtop=($(currentSection).offset().top-55)-$(window).scrollTop();$('html,body').animate({scrollTop:'+='+(scrtop)+'px'},'slow')});var thisZ=parentZ-1;$(currentSection).css('z-index',thisZ)},dataType:'html'})}
$(window).resize(function(){if($('.black-overlay').length){var cssObjOuter={'width':$(window).width(),'height':$(window).height()};var cssObjInner={'margin-left':$(window).width()*.40,'margin-top':$(window).height()*.2};$(".black-overlay").css(cssObjOuter);$(".lb-content").css(cssObjInner)}
    if($('#divcustomlightbox').length){var cssObjOuter={'display':'block','width':$('body').width(),'height':$(window).height()};var cssObjInner={'display':'block','width':$('body').width(),'height':$(window).height()-90};$('#divcustomlightbox').css(cssObjOuter);$('#divlbcontent').css(cssObjInner);if($('#divlbcontent').width()==null)
    {$('iframe').css({'width':$('#divcustomlightbox').width(),'height':$('#divcustomlightbox').height()})}
    else{$('iframe').css({'width':$('#divlbcontent').width(),'height':$('#divlbcontent').height()})}}});function closefullscreenlesson(){$('body').css('overflow','auto');$('#divcustomlightbox').remove();$('#divlbcontent').remove();$('#expedition-fullscreecn-header').remove();$("html, body").animate({scrollTop:$(document).height()},"slow")}
function showfullscreenlesson(fldrname,fldrnameinner,lessonid){$('html, body').animate({scrollTop:'0px'},0);$('body').css('overflow','hidden');var cssObjOuter={'display':'block','width':$('body').width(),'height':$(window).height()};var cssObjInner={'display':'block','width':$('body').width(),'height':$(window).height()-90};$('body').append('<div id="divcustomlightbox" title="Synergy ITC"><div class="btnprevclose"><p class="dialogTitleFullScr">Preview</p><a href="javascript:void(0);" onclick="closefullscreenlesson()" class="icon-synergy-close-dark"></a></div><div id="divlbcontent"><iframe src="http://'+cloudfront_url+'/scormlib/rte.php?SCOInstanceID='+fldrnameinner+'&lessonid='+fldrnameinner+'&zipname='+fldrname+'&hostname='+location.host+'" width="100%"></iframe></div><div class="diviplbottom"></div></div>');$('#divcustomlightbox').css(cssObjOuter);$('#divlbcontent').css(cssObjInner);$('iframe').css({'width':$('#divlbcontent').width(),'height':$('#divlbcontent').height()})}
function showfullscreenlessonpd(fldrname,fldpdlessonid,pdfname){$('html, body').animate({scrollTop:'0px'},0);$('body').css('overflow','hidden');var cssObjOuter={'display':'block','width':$('body').width(),'height':$(window).height()};var cssObjInner={'display':'block','width':$('body').width(),'height':$(window).height()-90};$('body').append('<div id="divcustomlightbox" title="Synergy ITC"><div class="btnprevclose"><a href="javascript:void(0);" onclick="closefullscreenlesson()" class="icon-synergy-close-dark" style="color:#24485f"></a></div><iframe src="http://'+cloudfront_url+'/webpdlesson/'+fldrname+'/'+pdfname+'/'+pdfname+'.html" width="100%" height="100%"></iframe></div>');$('#divcustomlightbox').css(cssObjOuter);$('#divlbcontent').css(cssObjInner);$('iframe').css({'width':$('#divlbcontent').width(),'height':$('#divlbcontent').height()});$('.btnprevclose').css({'height':'0'})}
function showstudentlessonpd(fldrname,fldpdlessonid,pdfname,schid){window.open('http://itc.nolaedu.net/library/pdlessons/library-pdlessons-studentviewscreen.php?fldrname='+fldrname+'&fldpdlessonid='+fldpdlessonid+'&pdfname='+pdfname+'&schid='+schid)}
function getscreenheight(){return $(window).height()}
function showfullscreenmodule(fldrname,type){$('html, body').animate({scrollTop:'0px'},0);$('body').css('overflow','hidden');var cssObjOuter={'display':'block','width':$('body').width(),'height':$(window).height()};var inner_fldr=fldrname.split(",");var ifrpath='';if(type==1)
{ifrpath='http://'+cloudfront_url+'/moduleplay/assignmentplayer.php'}
else if(type==3)
{ifrpath='http://'+cloudfront_url+'/moduleplay/questsplayer.php'}
else{ifrpath='http://'+cloudfront_url+'/moduleplay/moduleplayer.php'}
    $('body').append('<div id="divcustomlightbox" title="Synergy ITC"><iframe style="background-image: url(../img/loadinggif.gif);	background-repeat:no-repeat;background-position:center;" src="'+ifrpath+'?id='+escape(fldrname+','+$(window).height())+'&hostname='+location.host+'" width="100%" height="100%"></iframe></div>');$('#divcustomlightbox').css(cssObjOuter);$('iframe').css({'width':$('#divcustomlightbox').width(),'height':$('#divcustomlightbox').height()})}
function autoResize(id){var newheight;var newwidth;if(document.getElementById){newheight=document.getElementById(id).contentWindow.document.body.scrollHeight;newwidth=document.getElementById(id).contentWindow.document.body.scrollWidth}
    document.getElementById(id).height=(newheight)+"px";document.getElementById(id).width=(newwidth)+"px"}
function removesections(id){$(id).nextAll('section[class!="black-overlay"]').hide("fade").remove()}
$(document).delegate('.tag_well','click',function(){$('#'+$(this).children().attr('id')).focus()});function fn_click(id)
{if(id==0)
{setTimeout('removesections("#home");',200);setTimeout('showpages("classlock","classlock.php")',400)}
else if(id==1)
{setTimeout('removesections("#home");',200);setTimeout('showpages("studentlock","studentlock.php")',400)}
else if(id==2)
{setTimeout('removesections("#home");',200);setTimeout('showpages("tools-message-message","tools/message/tools-message-message.php")',400);setTimeout('showpages("tools-message","tools/message/tools-message.php?id=0")',600)}
else{setTimeout('removesections("#home");',200);setTimeout('showpages("tools-calendar-calendar","tools/calendar/tools-calendar-calendar.php")',400)}}
function fn_mouseover(id)
{if(id==0)
{$('#loaddiv').hover(function(){$('#classlok').show();$('#lok').hide();$('#cal').hide();$('#msg').hide()}).mouseleave(function(){$('#classlok').hide()})}
else if(id==1)
{$('#loaddiv').hover(function(){$('#lok').show();$('#classlok').hide();$('#cal').hide();$('#msg').hide()}).mouseleave(function(){$('#lok').hide()})}
else if(id==2)
{$('#loaddiv').hover(function(){$('#msg').show();$('#lok').hide();$('#cal').hide()}).mouseleave(function(){$('#msg').hide()})}
else{$('#loaddiv').hover(function(){$('#cal').show();$('#msg').hide();$('#lok').hide()}).mouseleave(function(){$('#cal').hide()})}}
var innercloading='<img src="img/AjaxLoader.gif" width="60" style="margin:5% 0 0 44%;" />';function isNumber(evt){evt=(evt)?evt:window.event;var charCode=(evt.which)?evt.which:evt.keyCode;if(charCode>31&&(charCode<48||charCode>57)){return!1}
    return!0}
...
{element=arr[fromIndex];arr.splice(fromIndex,1);arr.splice(toIndex,0,element)}
function arraycompare(arr1,arr2)
{arrresult=new Array();var arrresult=$(arr1).not(arr2).get();return arrresult}
function fn_classpro(uid,schoolid,indid)
{$(".loading-div").show();$("#results").load("ajaxpages/dashboardchart-ajax.php");$("#results").on("click",".pagination a",function(e){e.preventDefault();$(".loading-div").show();var page=$(this).attr("data-page");$("#results").load("ajaxpages/dashboardchart-ajax.php",{"page":page},function(){$(".loading-div").hide()})})}
function myFunction(){var dataparam="oper=teacheralert";$.ajax({type:'post',url:'ajaxpages/testalert.php',data:dataparam,beforeSend:function(){},success:function(ajaxdata){document.getElementById("myDropdown").classList.toggle("show");$('#myDropdown').html(ajaxdata);$("#upasses").css("display","inline");$("#downasses").css("display","none");if($('#myDropdown').hasClass("show"))
{$("#downasses").css("display","inline");$("#upasses").css("display","none")}}})}
function fn_testalert(){var dataparam="oper=teacheralert";$.ajax({type:'post',url:'ajaxpages/testalert.php',data:dataparam,beforeSend:function(){},success:function(ajaxdata){if(ajaxdata!=""){$('#teachermsg').show()}}})}(function($){$.extend($.fn,{validate:function(options){if(!this.length){options&&options.debug&&window.console&&console.warn("nothing selected, can't validate, returning nothing");return}
    ...
    this.toHide=this.toHide.not(this.toShow);this.hideErrors();this.addWrapper(this.toShow).show()},validElements:function(){return this.currentElements.not(this.invalidElements())},invalidElements:function(){return $(this.errorList).map(function(){return this.element})},showLabel:function(element,message){var label=this.errorsFor(element);if(label.length){label.removeClass(this.settings.validClass).addClass(this.settings.errorClass);label.attr("generated")&&label.html(message+"<span class='caret'></span>")}else{label=$("<"+this.settings.errorElement+"/>").attr({"for":this.idOrName(element),generated:!0}).addClass(this.settings.errorClass).html(message+"<span class='caret'></span>"||"");if(this.settings.wrapper){label=label.hide().show().wrap("<"+this.settings.wrapper+"/>").parent()}
    ...
    return ajax.apply(this,arguments)}}})(jQuery);(function($){if(!jQuery.event.special.focusin&&!jQuery.event.special.focusout&&document.addEventListener){$.each({focus:'focusin',blur:'focusout'},function(original,fix){$.event.special[fix]={setup:function(){this.addEventListener(original,handler,!0)},teardown:function(){this.removeEventListener(original,handler,!0)},handler:function(e){arguments[0]=$.event.fix(e);arguments[0].type=fix;return $.event.handle.apply(this,arguments)}};function handler(e){e=$.event.fix(e);e.type=fix;return $.event.handle.call(this,e)}})};$.extend($.fn,{validateDelegate:function(delegate,type,handler){return this.bind(type,function(event){var target=$(event.target);if(target.is(delegate)){return handler.apply(target,arguments)}})}})})(jQuery);$.validator.addMethod("letterswithbasicpunc",function(value,element){return this.optional(element)||/^[a-z-.,()'\"\s]+$/i.test(value)},"Letters or punctuation only please");$.validator.addMethod("phone_number",function(value,element){return this.optional(element)||value==="NA"||value.match(/^[0-9]+$/)},"Please enter a valid phone number");$.validator.addMethod("letterswithbasicpunc",function(value,element){return this.optional(element)||/^[a-z0-9-_.,#()&':;\"\s]+$/i.test(value)},"Letters, numbers and basic punctuation are allowed");$.validator.addMethod("alphanumeric",function(value,element){return this.optional(element)||/^\w+\s$/i.test(value)},"Letters, numbers, spaces or underscores are allowed");$.validator.addMethod("lettersonly",function(value,element){return this.optional(element)||/^([a-zA-Z0-9-_']+\s?)*$/i.test(value)},"Letters, numbers, spaces and underscores are allowed");$.validator.addMethod("lettersonlyschedule",function(value,element){return this.optional(element)||/^([a-zA-Z0-9-_']+\s?)*$/i.test(value)},"Symbols are not allowed");$.validator.addMethod("chkusername",function(value,element){return this.optional(element)||/^[A-Za-z0-9_]{3,100}$/i.test(value)},"Alphabetic characters, numbers and underscores are allowed");$.validator.addMethod('filesize',function(value,element,param){return this.optional(element)||(element.files[0].size<=param)});$.validator.addMethod("placeholder",function(value,element){return value!=$(element).attr("placeholder")},$.validator.messages.required);$.validator.addMethod("quantity",function(value,element){return!this.optional(element)});jQuery.validator.addMethod("greaterThan",function(value,element,params){if(!/Invalid|NaN/.test(new Date(value))){return new Date(value)>=new Date($(params).val())}
    return isNaN(value)&&isNaN($(params).val())||(Number(value)>=Number($(params).val()))},'Must be greater than {0}.');jQuery.fn.ForceNumericOnly=function(){return this.each(function(){$(this).keydown(function(e){var key=e.charCode||e.keyCode||0;return(key==8||key==9||key==46||(key>=37&&key<=40)||(key>=48&&key<=57)||(key>=96&&key<=105))})})};function ampreplace(str){return str.replace(/&/g,"%26")}
function trim(stringToTrim){return stringToTrim.replace(/^\s+|\s+$/g,"")}(function($){$.GrowingInput=function(element,options){var value,lastValue,calc;options=$.extend({min:0,max:null,startWidth:15,correction:15},options);element=$(element).data('growing',this);var self=this;var init=function(){calc=$('<span></span>').css({'float':'left','display':'inline-block','position':'absolute','left':-1000}).insertAfter(element);$.each(['font-size','font-family','padding-left','padding-top','padding-bottom','padding-right','border-left','border-right','border-top','border-bottom','word-spacing','letter-spacing','text-indent','text-transform'],function(i,p){calc.css(p,element.css(p))});element.blur(resize).keyup(resize).keydown(resize).keypress(resize);resize()};var calculate=function(chars){calc.text(chars);var width=calc.width();return(width?width:options.startWidth)+options.correction};var resize=function(){lastValue=value;value=element.val();var retValue=value;if(chk(options.min)&&value.length<options.min){if(chk(lastValue)&&(lastValue.length<=options.min))return;retValue=str_pad(value,options.min,'-')}else if(chk(options.max)&&value.length>options.max){if(chk(lastValue)&&(lastValue.length>=options.max))return;retValue=value.substr(0,options.max)}
    element.width(calculate(retValue));return self};this.resize=resize;init()};var chk=function(v){return!!(v||v===0)};var str_repeat=function(str,times){return new Array(times+1).join(str)};var str_pad=function(self,length,str,dir){if(self.length>=length)return this;str=str||' ';var pad=str_repeat(str,length-self.length).substr(0,length-self.length);if(!dir||dir=='right')return self+pad;if(dir=='left')return pad+self;return pad.substr(0,(pad.length/2).floor())+self+pad.substr(0,(pad.length/2).ceil())}})(jQuery);(function($){$.TextboxList=function(element,_options){var original,container,list,current,focused=!1,index=[],blurtimer,events={};var options=$.extend(!0,{prefix:'textboxlist',max:null,unique:!1,uniqueInsensitive:!0,endEditableBit:!0,startEditableBit:!0,hideEditableBits:!0,inBetweenEditableBits:!0,keys:{previous:37,next:39},bitsOptions:{editable:{},box:{}},plugins:{},encode:function(o){return $.grep($.map(o,function(v){v=(chk(v[0])?v[0]:v[1]);return chk(v)?v.toString().replace(/,/,''):null}),function(o){return o!=undefined}).join(',')},decode:function(o){return o.split(',')}},_options);element=$(element);var self=this;var init=function(){original=element.css('display','none').attr('autocomplete','off').focus(focusLast);container=$('<div class="'+options.prefix+'" />').insertAfter(element).click(function(e){if((e.target==list.get(0)||e.target==container.get(0))&&(!focused||(current&&current.toElement().get(0)!=list.find(':last-child').get(0))))focusLast()});list=$('<ul class="'+options.prefix+'-bits" />').appendTo(container);for(var name in options.plugins)enablePlugin(name,options.plugins[name]);afterInit()};var enablePlugin=function(name,options){self.plugins[name]=new $.TextboxList[camelCase(capitalize(name))](self,options)};var afterInit=function(){if(options.endEditableBit)create('editable',null,{tabIndex:original.tabIndex}).inject(list);addEvent('bitAdd',update,!0);addEvent('bitRemove',update,!0);$(document).click(function(e){if(!focused)return;if(e.target.className.indexOf(options.prefix)!=-1){if(e.target==$(container).get(0))return;var parent=$(e.target).parents('div.'+options.prefix);if(parent.get(0)==container.get(0))return}
    blur()}).keydown(function(ev){if(!focused||!current)return;var caret=current.is('editable')?current.getCaret():null;var value=current.getValue()[1];var special=!!$.map(['shift','alt','meta','ctrl'],function(e){return ev[e]}).length;var custom=special||(current.is('editable')&&current.isSelected());var evStop=function(){ev.stopPropagation();ev.preventDefault()};switch(ev.which){case 8:if(current.is('box')){evStop();return current.remove()}
    case options.keys.previous:if(current.is('box')||((caret==0||!value.length)&&!custom)){evStop();focusRelative('prev')}
        break;case 46:if(current.is('box')){evStop();return current.remove()}
    case options.keys.next:if(current.is('box')||(caret==value.length&&!custom)){evStop();focusRelative('next')}}});setValues(options.decode(original.val()))};var create=function(klass,value,opt){if(klass=='box'){if(chk(options.max)&&list.children('.'+options.prefix+'-bit-box').length+1>options.max)return!1;if(options.unique&&$.inArray(uniqueValue(value),index)!=-1)return!1}
    return new $.TextboxListBit(klass,value,self,$.extend(!0,options.bitsOptions[klass],opt))};var uniqueValue=function(value){return chk(value[0])?value[0]:(options.uniqueInsensitive?value[1].toLowerCase():value[1])}
    var add=function(plain,id,html,afterEl){var b=create('box',[id,plain,html]);if(b){if(!afterEl||!afterEl.length)afterEl=list.find('.'+options.prefix+'-bit-box').filter(':last');b.inject(afterEl.length?afterEl:list,afterEl.length?'after':'top')}
        return self};var focusRelative=function(dir,to){var el=getBit(to&&$(to).length?to:current).toElement();var b=getBit(el[dir]());if(b)b.focus();return self};var focusLast=function(){var lastElement=list.children().filter(':last');if(lastElement)getBit(lastElement).focus();return self};var blur=function(){if(!focused)return self;if(current)current.blur();focused=!1;return fireEvent('blur')};var getBit=function(obj){return(obj.type&&(obj.type=='editable'||obj.type=='box'))?obj:$(obj).data('textboxlist:bit')};var getValues=function(){var values=[];list.children().each(function(){var bit=getBit(this);if(!bit.is('editable'))values.push(bit.getValue())});return values};var setValues=function(values){if(!values)return;$.each(values,function(i,v){if(v)add.apply(self,$.isArray(v)?[v[1],v[0],v[2]]:[v])})};var update=function(){original.val(options.encode(getValues()))};var addEvent=function(type,fn){if(events[type]==undefined)events[type]=[];var exists=!1;$.each(events[type],function(f){if(f===fn){exists=!0;return}});if(!exists)events[type].push(fn);return self};var fireEvent=function(type,args,delay){if(!events||!events[type])return self;$.each(events[type],function(i,fn){(function(){args=(args!=undefined)?splat(args):Array.prototype.slice.call(arguments);var returns=function(){return fn.apply(self||null,args)};if(delay)return setTimeout(returns,delay);return returns()})()});return self};var removeEvent=function(type,fn){if(events[type]){for(var i=events[type].length;i--;i){if(events[type][i]===fn)events[type].splice(i,1)}}
        return self};var isDuplicate=function(v){return $.inArray(uniqueValue(v),index)};this.onFocus=function(bit){if(current)current.blur();clearTimeout(blurtimer);current=bit;container.addClass(options.prefix+'-focus');if(!focused){focused=!0;fireEvent('focus',bit)}};this.onAdd=function(bit){if(options.unique&&bit.is('box'))index.push(uniqueValue(bit.getValue()));if(bit.is('box')){var prior=getBit(bit.toElement().prev());if((prior&&prior.is('box')&&options.inBetweenEditableBits)||(!prior&&options.startEditableBit)){var priorEl=prior&&prior.toElement().length?prior.toElement():!1;var b=create('editable').inject(priorEl||list,priorEl?'after':'top');if(options.hideEditableBits)b.hide()}}};this.onRemove=function(bit){if(!focused)return;if(options.unique&&bit.is('box')){var i=isDuplicate(bit.getValue());if(i!=-1)index=index.splice(i+1,1)}
        var prior=getBit(bit.toElement().prev());if(prior&&prior.is('editable'))prior.remove();focusRelative('next',bit)};this.onBlur=function(bit,all){current=null;container.removeClass(options.prefix+'-focus');blurtimer=setTimeout(blur,all?0:200)};this.setOptions=function(opt){options=$.extend(!0,options,opt)};this.getOptions=function(){return options};this.getContainer=function(){return container};this.isDuplicate=isDuplicate;this.addEvent=addEvent;this.removeEvent=removeEvent;this.fireEvent=fireEvent;this.create=create;this.add=add;this.getValues=getValues;this.plugins=[];init()};$.TextboxListBit=function(type,value,textboxlist,_options){var element,bit,prefix,typeprefix,close,hidden,focused=!1,name=capitalize(type);var options=$.extend(!0,type=='box'?{deleteButton:!0}:{tabIndex:null,growing:!0,growingOptions:{},stopEnter:!0,addOnBlur:!1,addKeys:[13]},_options);this.type=type;this.value=value;var self=this;var init=function(){prefix=textboxlist.getOptions().prefix+'-bit';typeprefix=prefix+'-'+type;bit=$('<li />').addClass(prefix).addClass(typeprefix).data('textboxlist:bit',self).hover(function(){bit.addClass(prefix+'-hover').addClass(typeprefix+'-hover')},function(){bit.removeClass(prefix+'-hover').removeClass(typeprefix+'-hover')});if(type=='box'){bit.html(chk(self.value[2])?self.value[2]:self.value[1]).click(focus);if(options.deleteButton){bit.addClass(typeprefix+'-deletable');close=$('<a href="#" class="'+typeprefix+'-deletebutton" />').click(remove).appendTo(bit)}
    bit.children().click(function(e){e.stopPropagation();e.preventDefault()})}else{element=$('<input maxlength=50 type="text" class="'+typeprefix+'-input" autocomplete="off" onkeypress="if(event.keyCode==43 || event.keyCode==44 ||event.keyCode==47 ||event.keyCode==126) {return false;}" />').val(self.value?self.value[1]:'').appendTo(bit);if(chk(options.tabIndex))element.tabIndex=options.tabIndex;if(options.growing)new $.GrowingInput(element,options.growingOptions);element.focus(function(){focus(!0)}).blur(function(){blur(!0);if(options.addOnBlur)toBox()});if(options.addKeys||options.stopEnter){element.keydown(function(ev){if(!focused)return;var evStop=function(){ev.stopPropagation();ev.preventDefault()};if(options.stopEnter&&ev.which===13)evStop();if($.inArray(ev.which,splat(options.addKeys))!=-1){evStop();toBox()}})}}};var inject=function(el,where){switch(where||'bottom'){case 'top':bit.prependTo(el);break;case 'bottom':bit.appendTo(el);break;case 'before':bit.insertBefore(el);break;case 'after':bit.insertAfter(el);break}
    textboxlist.onAdd(self);return fireBitEvent('add')};var focus=function(noReal){if(focused)return self;show();focused=!0;textboxlist.onFocus(self);bit.addClass(prefix+'-focus').addClass(prefix+'-'+type+'-focus');fireBitEvent('focus');if(type=='editable'&&!noReal)element.focus();return self};var blur=function(noReal){if(!focused)return self;focused=!1;textboxlist.onBlur(self);bit.removeClass(prefix+'-focus').removeClass(prefix+'-'+type+'-focus');fireBitEvent('blur');if(type=='editable'){if(!noReal)element.blur();if(hidden&&!element.val().length)hide()}
    return self};var remove=function(){blur();textboxlist.onRemove(self);bit.remove();return fireBitEvent('remove')};var show=function(){bit.css('display','block');return self};var hide=function(){bit.css('display','none');hidden=!0;return self};var fireBitEvent=function(type){type=capitalize(type);textboxlist.fireEvent('bit'+type,self).fireEvent('bit'+name+type,self);return self};this.is=function(t){return type==t};this.setValue=function(v){if(type=='editable'){element.val(chk(v[0])?v[0]:v[1]);if(options.growing)element.data('growing').resize()}else value=v;return self};this.getValue=function(){return type=='editable'?[null,element.val(),null]:value};if(type=='editable'){this.getCaret=function(){var el=element.get(0);if(el.createTextRange){var r=document.selection.createRange().duplicate();r.moveEnd('character',el.value.length);if(r.text==='')return el.value.length;return el.value.lastIndexOf(r.text)}else return el.selectionStart};this.getCaretEnd=function(){var el=element.get(0);if(el.createTextRange){var r=document.selection.createRange().duplicate();r.moveStart('character',-el.value.length);return r.text.length}else return el.selectionEnd};this.isSelected=function(){return focused&&(self.getCaret()!==self.getCaretEnd())};var toBox=function(){var value=self.getValue();var b=textboxlist.create('box',value);if(b){b.inject(bit,'before');self.setValue([null,'',null]);return b}
    return null};this.toBox=toBox}
    this.toElement=function(){return bit};this.focus=focus;this.blur=blur;this.remove=remove;this.inject=inject;this.show=show;this.hide=hide;this.fireBitEvent=fireBitEvent;init()};var chk=function(v){return!!(v||v===0)};var splat=function(a){return $.isArray(a)?a:[a]};var camelCase=function(str){return str.replace(/-\D/g,function(match){return match.charAt(1).toUpperCase()})};var capitalize=function(str){return str.replace(/\b[a-z]/g,function(A){return A.toUpperCase()})};$.fn.extend({textboxlist:function(options){return this.each(function(){new $.TextboxList(this,options)})}})})(jQuery);(function(){$.TextboxList.Autocomplete=function(textboxlist,_options){var index,prefix,method,container,list,values=[],searchValues=[],results=[],placeholder=!1,current,currentInput,hidetimer,doAdd,currentSearch,currentRequest;var options=$.extend(!0,{minLength:1,maxResults:500,insensitive:!0,highlight:!0,highlightSelector:null,mouseInteraction:!0,onlyFromValues:!1,queryRemote:!1,remote:{url:'',param:'search',extraParams:{},loadPlaceholder:'Please wait...'},method:'standard',placeholder:'Type to receive suggestions'},_options);var init=function(){textboxlist.addEvent('bitEditableAdd',setupBit).addEvent('bitEditableFocus',search).addEvent('bitEditableBlur',hide).setOptions({bitsOptions:{editable:{addKeys:!1,stopEnter:!1}}});if($.browser.msie)textboxlist.setOptions({bitsOptions:{editable:{addOnBlur:!1}}});prefix=textboxlist.getOptions().prefix+'-autocomplete';method=$.TextboxList.Autocomplete.Methods[options.method];container=$('<div class="'+prefix+'" />').width('100%').appendTo(textboxlist.getContainer());if(chk(options.placeholder))placeholder=$('<div class="'+prefix+'-placeholder" />').html(options.placeholder).appendTo(container);list=$('<ul class="'+prefix+'-results" />').appendTo(container).click(function(ev){ev.stopPropagation();ev.preventDefault()})};var setupBit=function(bit){bit.toElement().keydown(navigate).keyup(function(){search()})};var search=function(bit){if(bit)currentInput=bit;if(!options.queryRemote&&!values.length)return;var search=$.trim(currentInput.getValue()[1]);if(search.length<options.minLength)showPlaceholder();if(search==currentSearch)return;currentSearch=search;list.css('display','none');if(search.length<options.minLength)return;if(options.queryRemote){if(searchValues[search]){values=searchValues[search]}else{var data=options.remote.extraParams;data[options.remote.param]=search;if(currentRequest)currentRequest.abort();currentRequest=$.ajax({url:options.remote.url,data:data,type:'POST',dataType:'json',success:function(r){searchValues[search]=r;values=r;showResults(search)}})}}
    showResults(search)};var showResults=function(search){var results=method.filter(values,search,options.insensitive,options.maxResults);if(textboxlist.getOptions().unique){results=$.grep(results,function(v){return textboxlist.isDuplicate(v)==-1})}
    hidePlaceholder();if(!results.length)return;blur();list.empty().css('display','block');$.each(results,function(i,r){addResult(r,search)});if(options.onlyFromValues)focusFirst();results=results};var addResult=function(r,searched){var element=$('<li class="'+prefix+'-result" />').html(r[3]?r[3]:r[1]).data('textboxlist:auto:value',r);element.appendTo(list);if(options.highlight)$(options.highlightSelector?element.find(options.highlightSelector):element).each(function(){if($(this).html())method.highlight($(this),searched,options.insensitive,prefix+'-highlight')});if(options.mouseInteraction){element.css('cursor','pointer').hover(function(){focus(element)}).mousedown(function(ev){ev.stopPropagation();ev.preventDefault();clearTimeout(hidetimer);doAdd=!0}).mouseup(function(){if(doAdd){addCurrent();currentInput.focus();search();doAdd=!1}});if(!options.onlyFromValues)element.mouseleave(function(){if(current&&(current.get(0)==element.get(0)))blur()})}};var hide=function(){hidetimer=setTimeout(function(){hidePlaceholder();list.css('display','none');currentSearch=null},$.browser.msie?150:0)};var showPlaceholder=function(){if(placeholder)placeholder.css('display','block')};var hidePlaceholder=function(){if(placeholder)placeholder.css('display','none')};var focus=function(element){if(!element||!element.length)return;blur();current=element.addClass(prefix+'-result-focus')};var blur=function(){if(current&&current.length){current.removeClass(prefix+'-result-focus');current=null}};var focusFirst=function(){return focus(list.find(':first'))};var focusRelative=function(dir){if(!current||!current.length)return self;return focus(current[dir]())};var addCurrent=function(){var value=current.data('textboxlist:auto:value');var b=textboxlist.create('box',value.slice(0,3));if(b){b.autoValue=value;if($.isArray(index))index.push(value);currentInput.setValue([null,'',null]);b.inject(currentInput.toElement(),'before')}
    blur();return self};var navigate=function(ev){var evStop=function(){ev.stopPropagation();ev.preventDefault()};switch(ev.which){case 38:evStop();(!options.onlyFromValues&&current&&current.get(0)===list.find(':first').get(0))?blur():focusRelative('prev');break;case 40:evStop();(current&&current.length)?focusRelative('next'):focusFirst();break;case 13:evStop();if(current&&current.length)addCurrent();else if(!options.onlyFromValues){var value=currentInput.getValue();var b=textboxlist.create('box',value);if(b){b.inject(currentInput.toElement(),'before');currentInput.setValue([null,'',null])}}}};this.setValues=function(v){values=v};init()};$.TextboxList.Autocomplete.Methods={standard:{filter:function(values,search,insensitive,max){var newvals=[],regexp=new RegExp('\\b'+escapeRegExp(search),insensitive?'i':'');for(var i=0;i<values.length;i++){if(newvals.length===max)break;if(regexp.test(values[i][1]))newvals.push(values[i])}
    return newvals},highlight:function(element,search,insensitive,klass){var regex=new RegExp('(<[^>]*>)|(\\b'+escapeRegExp(search)+')',insensitive?'ig':'g');return element.html(element.html().replace(regex,function(a,b,c){return(a.charAt(0)=='<')?a:'<strong class="'+klass+'">'+c+'</strong>'}))}}};var chk=function(v){return!!(v||v===0)};var escapeRegExp=function(str){return str.replace(/([-.*+?^${}()|[\]\/\\])/g,"\\$1")}})(jQuery);!function($){"use strict";var toggle='[data-toggle=selectbox]',SelectBox=function(element){}
    SelectBox.prototype={constructor:SelectBox,toggle:function(e){var $this=$(this),$parent,isActive
        ...
        try{var pagemaintop=$(document).height();var offs=$(this).next('div').offset();var Classname=$(this).next('div').attr('class');var hei=$(this).offset();var totaltop=hei.top+offs.top;var dropdownheight=$(this).height()+$(this).next('div').height();var bottom=$(this).next('div').closest('section[class!="black-overlay"]').position().top+$(this).next('div').closest('section[class!="black-overlay"]').outerHeight(!0)
            var currsection=$(this).next('div').closest('section[class!="black-overlay"]').height();var totaldropli=$(this).next('div').find('ul > li ').length;var calculatedropdown=offs.top+$(this).next('div').height();if(totaldropli>2&&parseInt(bottom)<=calculatedropdown)
            {$(this).next('div').css('top',-dropdownheight)}
            else{$(this).removeAttr('style')}}
        catch(e)
        {}
        return!1},filter:function(e){var $this,$parent,$items
        $this=$(this)
        $parent=$this.closest('.selectbox')
        $items=$('[role=options] li',$parent)
        $items.css('display','none')
        $items.filter(function(){return($this.val().toUpperCase()===$(this).text().toUpperCase().substr(0,$this.val().toUpperCase().length))}).css('display','block')},keydown:function(e){var $this,$items,$active,$parent,isActive,index
        ...
        $('body').on('mouseenter.selectbox.data-api','[role=options] > li > a',SelectBox.prototype.mouseenter)},mouseenter:function(e){var $this
        $this=$(this)
        if($this.is('.disabled, :disabled'))return
    ...
    function getParent($this){var selector=$this.attr('data-target'),$parent
        ...
        return $parent}
    $.fn.selectbox=function(option){return this.each(function(){var $this=$(this),data=$this.data('selectbox')
        this.type='selectbox';if(!data)$this.data('selectbox',(data=new SelectBox(this)))
        if(typeof option=='string')data[option].call($this)})}
    $.fn.selectbox.Constructor=SelectBox
    $.valHooks.selectbox={get:function(el){return $(el).find('input[type="hidden"]').val()},set:function(el,val){var $el=$(el);$el.find('input[type="hidden"]').val(val);$el.find('.selectbox-option').text(val)}}
    $(function(){$('html').on('click.selectbox.data-api',clearMenus)
        $('body').on('click.selectbox.data-api touchstart.selectbox.data-api',toggle,SelectBox.prototype.toggle).on('keydown.selectbox.data-api',toggle+', [role=options]',SelectBox.prototype.keydown).on('mouseenter.selectbox.data-api','[role=options] > li > a',SelectBox.prototype.mouseenter).on('click.selectbox.data-api','[role=options] > li > a',SelectBox.prototype.select).on('click.selectbox.data-api','.selectbox-filter',function(e){return!1}).on('propertychange.selectbox.data-api change.selectbox.data-api input.selectbox.data-api paste.selectbox.data-api','.selectbox-filter',SelectBox.prototype.filter)})}(window.jQuery);(function($){function maybeCall(thing,ctx){return(typeof thing=='function')?(thing.call(ctx)):thing};function isElementInDOM(ele){while(ele=ele.parentNode){if(ele==document)return!0}
    ...
    return this};$.fn.tipsy.defaults={className:null,delayIn:0,delayOut:0,fade:!1,fallback:'',gravity:'n',html:!0,live:!1,offset:0,opacity:0.8,title:'title',trigger:'hover'};$.fn.tipsy.revalidate=function(){$('.tipsy').each(function(){var pointee=$.data(this,'tipsy-pointee');if(!pointee||!isElementInDOM(pointee)){$(this).remove()}})};$.fn.tipsy.elementOptions=function(ele,options){return $.metadata?$.extend({},options,$(ele).metadata()):options};$.fn.tipsy.autoNS=function(){return $(this).offset().top>($(document).scrollTop()+$(window).height()/2)?'s':'n'};$.fn.tipsy.autoWE=function(){return $(this).offset().left>($(document).scrollLeft()+$(window).width()/2)?'e':'w'};$.fn.tipsy.autoBounds=function(margin,prefer){return function(){var dir={ns:prefer[0],ew:(prefer.length>1?prefer[1]:!1)},boundTop=$(document).scrollTop()+margin,boundLeft=$(document).scrollLeft()+margin,$this=$(this);if($this.offset().top<boundTop)dir.ns='n';if($this.offset().left<boundLeft)dir.ew='w';if($(window).width()+$(document).scrollLeft()-$this.offset().left<margin)dir.ew='e';if($(window).height()+$(document).scrollTop()-$this.offset().top<margin)dir.ns='s';return dir.ns+(dir.ew?dir.ew:'')}}})(jQuery);(function($){jQuery.fn.extend({slimScroll:function(options){var defaults={width:'auto',height:'250px',size:'7px',color:'#000',position:'right',distance:'1px',start:'top',opacity:.4,alwaysVisible:!1,disableFadeOut:!1,railVisible:!1,railColor:'#333',railOpacity:.2,railDraggable:!0,railClass:'slimScrollRail',barClass:'slimScrollBar',wrapperClass:'slimScrollDiv',allowPageScroll:!1,wheelStep:20,touchScrollStep:200,borderRadius:'7px',railBorderRadius:'7px'};var o=$.extend(defaults,options);this.each(function(){var isOverPanel,isOverBar,isDragg,queueHide,touchDif,barHeight,percentScroll,lastScroll,divS='<div></div>',minBarHeight=30,releaseScroll=!1;var me=$(this);if(me.parent().hasClass(o.wrapperClass))
...
{if('height' in options&&options.height=='auto'){me.parent().css('height','auto');me.css('height','auto');var height=me.parent().parent().height();me.parent().css('height',height);me.css('height',height)}
    ...
    $wrapper=$self.closest('.fht-table-wrapper');if(settings.fixedColumn==!0&&settings.fixedColumns<=0){settings.fixedColumns=1}
    if(settings.fixedColumns>0&&$wrapper.find('.fht-fixed-column').length==0){$self.wrap('<div class="fht-fixed-body"></div>');var $fixedColumns=$('<div class="fht-fixed-column" ></div>').prependTo($wrapper),$fixedBody=$wrapper.find('.fht-fixed-body')}
    ...
    $divBody=$self.closest('.fht-tbody');var tableProps=helpers._getTableProps($self);helpers._setupClone($divBody,tableProps.tbody);if(!$self.hasClass('fht-table-init')){if(settings.fixedColumns>0){$divHead=$('<div class="fht-thead"><table class="fht-table"></table></div>').prependTo($fixedBody)}else{$divHead=$('<div class="fht-thead"><table class="fht-table"></table></div>').prependTo($wrapper)}
        $divHead.find('table.fht-table').addClass(settings.originalTable.attr('class'));$thead.clone().appendTo($divHead.find('table'))}else{$divHead=$wrapper.find('div.fht-thead')}
    helpers._setupClone($divHead,tableProps.thead);$self.css({'margin-top':-$divHead.outerHeight(!0)-1});if(settings.footer==!0){helpers._setupTableFooter($self,self,tableProps);if(!$tfoot.length){$tfoot=$wrapper.find('div.fht-tfoot table')}
        tfootHeight=$tfoot.outerHeight(!0)}
    var tbodyHeight=$wrapper.height()-67-tfootHeight-tableProps.border;$divBody.css({'height':tbodyHeight});$self.addClass('fht-table-init');if(typeof(settings.altClass)!=='undefined'){methods.altRows.apply(self)}
    ...
    var helpers={_isTable:function($obj){var $self=$obj,hasTable=$self.is('table'),hasThead=$self.find('thead').length>0,hasTbody=$self.find('tbody').length>0;if(hasTable&&hasThead&&hasTbody){return!0}
        return!1},_bindScroll:function($obj,tableProps){var $self=$obj,$wrapper=$self.closest('.fht-table-wrapper'),$thead=$self.siblings('.fht-thead'),$tfoot=$self.siblings('.fht-tfoot');$self.bind('scroll',function(){if(settings.fixedColumns>0){var $fixedColumns=$wrapper.find('.fht-fixed-column');$fixedColumns.find('.fht-tbody table').css({'margin-top':-$self.scrollTop()})}
        $thead.find('table').css({'margin-left':-this.scrollLeft});if(settings.footer||settings.cloneHeadToFoot){$tfoot.find('table').css({'margin-left':-this.scrollLeft})}})},_fixHeightWithCss:function($obj,tableProps){if(settings.includePadding){$obj.css({'height':39,'padding-top':22})}else{$obj.css({'height':$obj.parent().height()+tableProps.border})}},_fixWidthWithCss:function($obj,tableProps,width){if(settings.includePadding){$obj.each(function(index){if($obj.is('td')){$(this).css({'width':205})}else{$(this).css({'width':width==undefined?$(this).width()+tableProps.border:width+tableProps.border})}})}else{$obj.each(function(index){$(this).css({'width':width==undefined?$(this).parent().width()+tableProps.border:width+tableProps.border})})}},_setupFixedColumn:function($obj,obj,tableProps){var $self=$obj,self=obj,$wrapper=$self.closest('.fht-table-wrapper'),$fixedBody=$wrapper.find('.fht-fixed-body'),$fixedColumn=$wrapper.find('.fht-fixed-column'),$thead=$('<div class="fht-thead" style="height:68px;"><table class="fht-table"><thead><tr></tr></thead></table></div>'),$tbody=$('<div class="fht-tbody"><table class="fht-table"><tbody></tbody></table></div>'),$tfoot=$('<div class="fht-tfoot"><table class="fht-table"><tfoot><tr></tr></tfoot></table></div>'),$firstThChildren,$firstTdChildren,fixedColumnWidth,fixedBodyWidth=$wrapper.width(),fixedBodyHeight=$fixedBody.find('.fht-tbody').height()-settings.scrollbarOffset,$newRow;$thead.find('table.fht-table').addClass(settings.originalTable.attr('class'));$tbody.find('table.fht-table').addClass(settings.originalTable.attr('class'));$tfoot.find('table.fht-table').addClass(settings.originalTable.attr('class'));$firstThChildren=$fixedBody.find('.fht-thead thead tr > *:lt('+settings.fixedColumns+')');fixedColumnWidth=settings.fixedColumns*tableProps.border;$firstThChildren.each(function(index){fixedColumnWidth+=$(this).outerWidth(!0)});helpers._fixHeightWithCss($firstThChildren,tableProps);helpers._fixWidthWithCss($firstThChildren,tableProps);var tdWidths=[];$firstThChildren.each(function(index){tdWidths.push($(this).width())});firstTdChildrenSelector='tbody tr > *:not(:nth-child(n+'+(settings.fixedColumns+1)+'))';$firstTdChildren=$fixedBody.find(firstTdChildrenSelector).each(function(index){helpers._fixHeightWithCss($(this),tableProps);helpers._fixWidthWithCss($(this),tableProps,tdWidths[index%settings.fixedColumns])});$thead.appendTo($fixedColumn).find('tr').append($firstThChildren.clone());$tbody.appendTo($fixedColumn).css({'margin-top':-1,'height':fixedBodyHeight+tableProps.border});var $newRow;$firstTdChildren.each(function(index){if(index%settings.fixedColumns==0){$newRow=$('<tr></tr>').appendTo($tbody.find('tbody'));if(settings.altClass&&$(this).parent().hasClass(settings.altClass)){$newRow.addClass(settings.altClass)}}
        $(this).clone().appendTo($newRow)});$fixedColumn.css({'height':0,'width':fixedColumnWidth+12})
        var maxTop=$fixedColumn.find('.fht-tbody .fht-table').height()-$fixedColumn.find('.fht-tbody').height();$fixedColumn.find('.fht-table').bind('mousewheel',function(event,delta,deltaX,deltaY){if(deltaY==0)return;var top=parseInt($(this).css('marginTop'),10)+(deltaY>0?120:-120);if(top>0)top=0;if(top<-maxTop)top=-maxTop;$(this).css('marginTop',top);$fixedBody.find('.fht-tbody').scrollTop(-top).scroll();return!1});$fixedBody.css({'width':fixedBodyWidth});if(settings.footer==!0||settings.cloneHeadToFoot==!0){var $firstTdFootChild=$fixedBody.find('.fht-tfoot tr > *:lt('+settings.fixedColumns+')');helpers._fixHeightWithCss($firstTdFootChild,tableProps);$tfoot.appendTo($fixedColumn).find('tr').append($firstTdFootChild.clone());footwidth=$tfoot.find('table').innerWidth();$tfoot.css({'top':settings.scrollbarOffset,'width':footwidth})}},_setupTableFooter:function($obj,obj,tableProps){var $self=$obj,self=obj,$wrapper=$self.closest('.fht-table-wrapper'),$tfoot=$self.find('tfoot'),$divFoot=$wrapper.find('div.fht-tfoot');if(!$divFoot.length){if(settings.fixedColumns>0){$divFoot=$('<div class="fht-tfoot"><table class="fht-table"></table></div>').appendTo($wrapper.find('.fht-fixed-body'))}else{$divFoot=$('<div class="fht-tfoot"><table class="fht-table"></table></div>').appendTo($wrapper)}}
        $divFoot.find('table.fht-table').addClass(settings.originalTable.attr('class'));switch(!0){case!$tfoot.length&&settings.cloneHeadToFoot==!0&&settings.footer==true:var $divHead=$wrapper.find('div.fht-thead');$divFoot.empty();$divHead.find('table').clone().appendTo($divFoot);break;case $tfoot.length&&settings.cloneHeadToFoot==!1&&settings.footer==true:$divFoot.find('table').append($tfoot).css({'margin-top':-tableProps.border});helpers._setupClone($divFoot,tableProps.tfoot);break}},_getTableProps:function($obj){var tableProp={thead:{},tbody:{},tfoot:{},border:0},borderCollapse=1;if(settings.borderCollapse==!0){borderCollapse=2}
        tableProp.border=($obj.find('th:first-child').outerWidth()-$obj.find('th:first-child').innerWidth())/borderCollapse;$obj.find('thead tr:first-child > *').each(function(index){tableProp.thead[index]=$(this).width()+tableProp.border});$obj.find('tfoot tr:first-child > *').each(function(index){tableProp.tfoot[index]=$(this).width()+tableProp.border});$obj.find('tbody tr:first-child > *').each(function(index){tableProp.tbody[index]=$(this).width()+tableProp.border});return tableProp},_setupClone:function($obj,cellArray){var $self=$obj,selector=($self.find('thead').length)?'thead tr:first-child > *':($self.find('tfoot').length)?'tfoot tr:first-child > *':'tbody tr:first-child > *',$cell;$self.find(selector).each(function(index){$cell=($(this).find('div.fht-cell').length)?$(this).find('div.fht-cell'):$('<div class="fht-cell"></div>').appendTo($(this));$cell.css({'width':201});if(!$(this).closest('.fht-tbody').length&&$(this).is(':last-child')&&!$(this).closest('.fht-fixed-column').length){var padding=(($(this).innerWidth()-$(this).width())/2)+settings.scrollbarOffset;$(this).css({'padding-right':'5px',})}})},_isPaddingIncludedWithWidth:function(){var $obj=$('<table class="fht-table"><tr><td style="padding: 10px; font-size: 10px;">test</td></tr></table>'),defaultHeight,newHeight;$obj.addClass(settings.originalTable.attr('class'));$obj.appendTo('body');defaultHeight=$obj.find('td').height();$obj.find('td').css('height',$obj.find('tr').height());newHeight=$obj.find('td').height();$obj.remove();if(defaultHeight!=newHeight){return!0}else{return!1}},_getScrollbarWidth:function(){var scrollbarWidth=0;if(!scrollbarWidth){if($.browser.msie){var $textarea1=$('<textarea cols="10" rows="2"></textarea>').css({position:'absolute',top:-1000,left:-1000}).appendTo('body'),$textarea2=$('<textarea cols="10" rows="2" style="overflow: hidden;"></textarea>').css({position:'absolute',top:-1000,left:-1000}).appendTo('body');scrollbarWidth=$textarea1.width()-$textarea2.width()+2;$textarea1.add($textarea2).remove()}else{var $div=$('<div />').css({width:100,height:100,overflow:'auto',position:'absolute',top:-1000,left:-1000}).prependTo('body').append('<div />').find('div').css({width:'100%',height:200});scrollbarWidth=100-$div.width();$div.parent().remove()}}
        return scrollbarWidth}}
    if(methods[method]){return methods[method].apply(this,Array.prototype.slice.call(arguments,1))}else if(typeof method==='object'||!method){return methods.init.apply(this,arguments)}else{$.error('Method "'+method+'" does not exist in fixedHeaderTable plugin!')}}})(jQuery);(function(){var $,Node,Tree,methods;$=jQuery;Node=(function(){function Node(row,tree,settings){var parentId;this.row=row;this.tree=tree;this.settings=settings;this.id=this.row.data(this.settings.nodeIdAttr);parentId=this.row.data(this.settings.parentIdAttr);if(parentId!=null&&parentId!==""){this.parentId=parentId}
    ...
    Node.prototype.addChild=function(child){return this.children.push(child)};Node.prototype.ancestors=function(){var ancestors,node;node=this;ancestors=[];while(node=node.parentNode()){ancestors.push(node)}
        ...
        this.row.removeClass("collapsed").addClass("expanded");this._showChildren();this.expander.attr("title",this.settings.stringCollapse);return this};Node.prototype.expanded=function(){return this.row.hasClass("expanded")};Node.prototype.hide=function(){this._hideChildren();this.row.hide();return this};Node.prototype.isBranchNode=function(){if(this.children.length>0||this.row.data(this.settings.branchAttr)===!0){return!0}else{return!1}};Node.prototype.level=function(){return this.ancestors().length};Node.prototype.parentNode=function(){if(this.parentId!=null){return this.tree[this.parentId]}else{return null}};Node.prototype.removeChild=function(child){var i=$.inArray(child,this.children);return this.children.splice(i,1)};Node.prototype.render=function(){var settings=this.settings,target;if(settings.expandable===!0&&this.isBranchNode()){this.indenter.html(this.expander);target=settings.clickableNodeNames===!0?this.treeCell:this.expander;target.unbind("click.treetable").bind("click.treetable",function(event){$(this).parents("table").treetable("node",$(this).parents("tr").data(settings.nodeIdAttr)).toggle();return event.preventDefault()})}
        if(settings.expandable===!0&&settings.initialState==="expanded"){this.collapse()}else{this.expand()}
    ...
    Tree.prototype.collapseAll=function(){var node,_i,_len,_ref,_results;_ref=this.nodes;_results=[];for(_i=0,_len=_ref.length;_i<_len;_i++){node=_ref[_i];_results.push(node.collapse())}
        ...
        return this};Tree.prototype.move=function(node,destination){if(node!==destination&&destination.id!==node.parentId&&$.inArray(node,destination.ancestors())===-1){node.setParent(destination);this._moveRows(node,destination);if(node.parentNode().children.length===1){node.parentNode().render()}}
        return this};Tree.prototype.render=function(){var root,_i,_len,_ref;_ref=this.roots;for(_i=0,_len=_ref.length;_i<_len;_i++){root=_ref[_i];root.show()}
        ...
        node.children=[];return this};return Tree})();methods={init:function(options){var settings;settings=$.extend({branchAttr:"ttBranch",clickableNodeNames:!1,column:0,columnElType:"td",expandable:!1,expanderTemplate:"<a href='#'>&nbsp;</a>",indent:19,indenterTemplate:"<span class='indenter'></span>",initialState:"collapsed",nodeIdAttr:"ttId",parentIdAttr:"ttParentId",stringExpand:"Expand",stringCollapse:"Collapse",onInitialized:null,onNodeCollapse:null,onNodeExpand:null,onNodeInitialized:null},options);return this.each(function(){var el,tree;tree=new Tree(this,settings);tree.loadRows(this.rows).render();el=$(this).addClass("treetable").data("treetable",tree);if(settings.onInitialized!=null){settings.onInitialized.apply(tree)}
...
$.fn.autoGrowInput=function(o){o=$.extend({maxWidth:1000,minWidth:0,comfortZone:70},o);this.filter('input:text').each(function(){var minWidth=o.minWidth||$(this).width(),val='',input=$(this),testSubject=$('<tester/>').css({position:'absolute',top:-9999,left:-9999,width:'auto',fontSize:input.css('fontSize'),fontFamily:input.css('fontFamily'),fontWeight:input.css('fontWeight'),letterSpacing:input.css('letterSpacing'),whiteSpace:'nowrap'}),check=function(){if(val===(val=input.val())){return}
    ...
    $.fn.countdown=function(options){var otherArgs=Array.prototype.slice.call(arguments,1);if(isNotChained(options,otherArgs)){return plugin['_'+options+'Plugin'].apply(plugin,[this[0]].concat(otherArgs))}
        ...
        else{plugin._attachPlugin(this,options||{})}})};var plugin=$.countdown=new Countdown()})(jQuery);String.prototype.format=function(){var s=this,i=arguments.length;while(i--){s=s.replace(new RegExp('\\{'+i+'\\}','gm'),arguments[i])}
    return s};!function($){$.timeoutDialog=function(options){var settings={timeout:1200,countdown:60,title:'Your session is about to expire!',message:'You will be logged out in {0} seconds.',question:'Do you want to stay signed in?',keep_alive_button_text:'Yes, Keep me signed in',sign_out_button_text:'No, Sign me out',keep_alive_url:'/keep-alive.php',logout_url:null,logout_redirect_url:'/',restart_on_yes:!0,dialog_width:350}
    $.extend(settings,options);var TimeoutDialog={init:function(){this.setupDialogTimer()},setupDialogTimer:function(){var self=this;window.setTimeout(function(){self.setupDialog()},(settings.timeout-settings.countdown)*1000)},setupDialog:function(){var self=this;self.destroyDialog();$('<div id="timeout-dialog"><div style="font-weight:bold;font-size:16px;padding-bottom:10px;" id="timeout-message"><center>'+settings.title+'</center></div>'+'<div id="timeout-message">'+settings.message.format('<span id="timeout-countdown">'+settings.countdown+'</span>')+'</div>'+'<div id="timeout-question">'+settings.question+'</div>'+'</div>').appendTo('body').dialog({modal:!0,width:settings.dialog_width+30,minHeight:'auto',zIndex:10000,closeOnEscape:!1,draggable:!1,resizable:!1,dialogClass:'timeout-dialog',hide:"explode",buttons:{'keep-alive-button':{text:settings.keep_alive_button_text,id:"timeout-keep-signin-btn",click:function(){self.keepAlive()}},'sign-out-button':{text:settings.sign_out_button_text,id:"timeout-sign-out-button",click:function(){self.signOut(!0)}}}});$('.ui-dialog-titlebar').remove();$('.ui-dialog-buttonpane').removeAttr('class');self.startCountdown()},destroyDialog:function(){if($("#timeout-dialog").length){$('#timeout-dialog').remove()}},startCountdown:function(){var self=this,counter=settings.countdown;this.countdown=window.setInterval(function(){counter-=1;$("#timeout-countdown").html(counter);if(counter<=0){window.clearInterval(self.countdown);self.signOut(!1)}},1000)},keepAlive:function(){var self=this;this.destroyDialog();window.clearInterval(this.countdown);$.get(settings.keep_alive_url,function(data){if(data=="OK"){if(settings.restart_on_yes){self.setupDialogTimer()}}
    else{self.signOut(!1)}})},signOut:function(is_forced){var self=this;this.destroyDialog();if(settings.logout_url!=null){$.post(settings.logout_url,function(data){self.redirectLogout(is_forced)})}
    else{self.redirectLogout(is_forced)}},redirectLogout:function(is_forced){var target=settings.logout_redirect_url+'?next='+encodeURIComponent(window.location.pathname+window.location.search);if(!is_forced)
        target+='&timeout=t';window.location=target}};TimeoutDialog.init()}}(window.jQuery);window.Modernizr=function(a,b,c){function z(a){j.cssText=a}function A(a,b){return z(m.join(a+";")+(b||""))}function B(a,b){return typeof a===b}function C(a,b){return!!~(""+a).indexOf(b)}function D(a,b){for(var d in a){var e=a[d];if(!C(e,"-")&&j[e]!==c)return b=="pfx"?e:!0}return!1}function E(a,b,d){for(var e in a){var f=b[a[e]];if(f!==c)return d===!1?a[e]:B(f,"function")?f.bind(d||b):f}return!1}function F(a,b,c){var d=a.charAt(0).toUpperCase()+a.slice(1),e=(a+" "+o.join(d+" ")+d).split(" ");return B(b,"string")||B(b,"undefined")?D(e,b):(e=(a+" "+p.join(d+" ")+d).split(" "),E(e,b,c))}var d="2.6.2",e={},f=!0,g=b.documentElement,h="modernizr",i=b.createElement(h),j=i.style,k,l={}.toString,m=" -webkit- -moz- -o- -ms- ".split(" "),n="Webkit Moz O ms",o=n.split(" "),p=n.toLowerCase().split(" "),q={},r={},s={},t=[],u=t.slice,v,w=function(a,c,d,e){var f,i,j,k,l=b.createElement("div"),m=b.body,n=m||b.createElement("body");if(parseInt(d,10))while(d--)j=b.createElement("div"),j.id=e?e[d]:h+(d+1),l.appendChild(j);return f=["&#173;",'<style id="s',h,'">',a,"</style>"].join(""),l.id=h,(m?l:n).innerHTML+=f,n.appendChild(l),m||(n.style.background="",n.style.overflow="hidden",k=g.style.overflow,g.style.overflow="hidden",g.appendChild(n)),i=c(l,a),m?l.parentNode.removeChild(l):(n.parentNode.removeChild(n),g.style.overflow=k),!!i},x={}.hasOwnProperty,y;!B(x,"undefined")&&!B(x.call,"undefined")?y=function(a,b){return x.call(a,b)}:y=function(a,b){return b in a&&B(a.constructor.prototype[b],"undefined")},Function.prototype.bind||(Function.prototype.bind=function(b){var c=this;if(typeof c!="function")throw new TypeError;var d=u.call(arguments,1),e=function(){if(this instanceof e){var a=function(){};a.prototype=c.prototype;var f=new a,g=c.apply(f,d.concat(u.call(arguments)));return Object(g)===g?g:f}return c.apply(b,d.concat(u.call(arguments)))};return e}),q.csstransforms3d=function(){var a=!!F("perspective");return a&&"webkitPerspective"in g.style&&w("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}",function(b,c){a=b.offsetLeft===9&&b.offsetHeight===3}),a},q.csstransitions=function(){return F("transition")};for(var G in q)y(q,G)&&(v=G.toLowerCase(),e[v]=q[G](),t.push((e[v]?"":"no-")+v));return e.addTest=function(a,b){if(typeof a=="object")for(var d in a)y(a,d)&&e.addTest(d,a[d]);else{a=a.toLowerCase();if(e[a]!==c)return e;b=typeof b=="function"?b():b,typeof f!="undefined"&&f&&(g.className+=" "+(b?"":"no-")+a),e[a]=b}return e},z(""),i=k=null,function(a,b){function k(a,b){var c=a.createElement("p"),d=a.getElementsByTagName("head")[0]||a.documentElement;return c.innerHTML="x<style>"+b+"</style>",d.insertBefore(c.lastChild,d.firstChild)}function l(){var a=r.elements;return typeof a=="string"?a.split(" "):a}function m(a){var b=i[a[g]];return b||(b={},h++,a[g]=h,i[h]=b),b}function n(a,c,f){c||(c=b);if(j)return c.createElement(a);f||(f=m(c));var g;return f.cache[a]?g=f.cache[a].cloneNode():e.test(a)?g=(f.cache[a]=f.createElem(a)).cloneNode():g=f.createElem(a),g.canHaveChildren&&!d.test(a)?f.frag.appendChild(g):g}function o(a,c){a||(a=b);if(j)return a.createDocumentFragment();c=c||m(a);var d=c.frag.cloneNode(),e=0,f=l(),g=f.length;for(;e<g;e++)d.createElement(f[e]);return d}function p(a,b){b.cache||(b.cache={},b.createElem=a.createElement,b.createFrag=a.createDocumentFragment,b.frag=b.createFrag()),a.createElement=function(c){return r.shivMethods?n(c,a,b):b.createElem(c)},a.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+l().join().replace(/\w+/g,function(a){return b.createElem(a),b.frag.createElement(a),'c("'+a+'")'})+");return n}")(r,b.frag)}function q(a){a||(a=b);var c=m(a);return r.shivCSS&&!f&&!c.hasCSS&&(c.hasCSS=!!k(a,"article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}mark{background:#FF0;color:#000}")),j||p(a,c),a}var c=a.html5||{},d=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,e=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,f,g="_html5shiv",h=0,i={},j;(function(){try{var a=b.createElement("a");a.innerHTML="<xyz></xyz>",f="hidden"in a,j=a.childNodes.length==1||function(){b.createElement("a");var a=b.createDocumentFragment();return typeof a.cloneNode=="undefined"||typeof a.createDocumentFragment=="undefined"||typeof a.createElement=="undefined"}()}catch(c){f=!0,j=!0}})();var r={elements:c.elements||"abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video",shivCSS:c.shivCSS!==!1,supportsUnknownElements:j,shivMethods:c.shivMethods!==!1,type:"default",shivDocument:q,createElement:n,createDocumentFragment:o};a.html5=r,q(b)}(this,b),e._version=d,e._prefixes=m,e._domPrefixes=p,e._cssomPrefixes=o,e.testProp=function(a){return D([a])},e.testAllProps=F,e.testStyles=w,e.prefixed=function(a,b,c){return b?F(a,b,c):F(a,"pfx")},g.className=g.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(f?" js "+t.join(" "):""),e}(this,this.document),function(a,b,c){function d(a){return"[object Function]"==o.call(a)}function e(a){return"string"==typeof a}function f(){}function g(a){return!a||"loaded"==a||"complete"==a||"uninitialized"==a}function h(){var a=p.shift();q=1,a?a.t?m(function(){("c"==a.t?B.injectCss:B.injectJs)(a.s,0,a.a,a.x,a.e,1)},0):(a(),h()):q=0}function i(a,c,d,e,f,i,j){function k(b){if(!o&&g(l.readyState)&&(u.r=o=1,!q&&h(),l.onload=l.onreadystatechange=null,b)){"img"!=a&&m(function(){t.removeChild(l)},50);for(var d in y[c])y[c].hasOwnProperty(d)&&y[c][d].onload()}}var j=j||B.errorTimeout,l=b.createElement(a),o=0,r=0,u={t:d,s:c,e:f,a:i,x:j};1===y[c]&&(r=1,y[c]=[]),"object"==a?l.data=c:(l.src=c,l.type=a),l.width=l.height="0",l.onerror=l.onload=l.onreadystatechange=function(){k.call(this,r)},p.splice(e,0,u),"img"!=a&&(r||2===y[c]?(t.insertBefore(l,s?null:n),m(k,j)):y[c].push(l))}function j(a,b,c,d,f){return q=0,b=b||"j",e(a)?i("c"==b?v:u,a,b,this.i++,c,d,f):(p.splice(this.i++,0,a),1==p.length&&h()),this}function k(){var a=B;return a.loader={load:j,i:0},a}var l=b.documentElement,m=a.setTimeout,n=b.getElementsByTagName("script")[0],o={}.toString,p=[],q=0,r="MozAppearance"in l.style,s=r&&!!b.createRange().compareNode,t=s?l:n.parentNode,l=a.opera&&"[object Opera]"==o.call(a.opera),l=!!b.attachEvent&&!l,u=r?"object":l?"script":"img",v=l?"script":u,w=Array.isArray||function(a){return"[object Array]"==o.call(a)},x=[],y={},z={timeout:function(a,b){return b.length&&(a.timeout=b[0]),a}},A,B;B=function(a){function b(a){var a=a.split("!"),b=x.length,c=a.pop(),d=a.length,c={url:c,origUrl:c,prefixes:a},e,f,g;for(f=0;f<d;f++)g=a[f].split("="),(e=z[g.shift()])&&(c=e(c,g));for(f=0;f<b;f++)c=x[f](c);return c}function g(a,e,f,g,h){var i=b(a),j=i.autoCallback;i.url.split(".").pop().split("?").shift(),i.bypass||(e&&(e=d(e)?e:e[a]||e[g]||e[a.split("/").pop().split("?")[0]]),i.instead?i.instead(a,e,f,g,h):(y[i.url]?i.noexec=!0:y[i.url]=1,f.load(i.url,i.forceCSS||!i.forceJS&&"css"==i.url.split(".").pop().split("?").shift()?"c":c,i.noexec,i.attrs,i.timeout),(d(e)||d(j))&&f.load(function(){k(),e&&e(i.origUrl,h,g),j&&j(i.origUrl,h,g),y[i.url]=2})))}function h(a,b){function c(a,c){if(a){if(e(a))c||(j=function(){var a=[].slice.call(arguments);k.apply(this,a),l()}),g(a,j,b,0,h);else if(Object(a)===a)for(n in m=function(){var b=0,c;for(c in a)a.hasOwnProperty(c)&&b++;return b}(),a)a.hasOwnProperty(n)&&(!c&&!--m&&(d(j)?j=function(){var a=[].slice.call(arguments);k.apply(this,a),l()}:j[n]=function(a){return function(){var b=[].slice.call(arguments);a&&a.apply(this,b),l()}}(k[n])),g(a[n],j,b,n,h))}else!c&&l()}var h=!!a.test,i=a.load||a.both,j=a.callback||f,k=j,l=a.complete||f,m,n;c(h?a.yep:a.nope,!!i),i&&c(i)}var i,j,l=this.yepnope.loader;if(e(a))g(a,0,l,0);else if(w(a))for(i=0;i<a.length;i++)j=a[i],e(j)?g(j,0,l,0):w(j)?B(j):Object(j)===j&&h(j,l);else Object(a)===a&&h(a,l)},B.addPrefix=function(a,b){z[a]=b},B.addFilter=function(a){x.push(a)},B.errorTimeout=1e4,null==b.readyState&&b.addEventListener&&(b.readyState="loading",b.addEventListener("DOMContentLoaded",A=function(){b.removeEventListener("DOMContentLoaded",A,0),b.readyState="complete"},0)),a.yepnope=k(),a.yepnope.executeStack=h,a.yepnope.injectJs=function(a,c,d,e,i,j){var k=b.createElement("script"),l,o,e=e||B.errorTimeout;k.src=a;for(o in d)k.setAttribute(o,d[o]);c=j?h:c||f,k.onreadystatechange=k.onload=function(){!l&&g(k.readyState)&&(l=1,c(),k.onload=k.onreadystatechange=null)},m(function(){l||(l=1,c(1))},e),i?k.onload():n.parentNode.insertBefore(k,n)},a.yepnope.injectCss=function(a,c,d,e,g,i){var e=b.createElement("link"),j,c=i?h:c||f;e.href=a,e.rel="stylesheet",e.type="text/css";for(j in d)e.setAttribute(j,d[j]);g||(n.parentNode.insertBefore(e,n),m(c,0))}}(this,document),Modernizr.load=function(){yepnope.apply(window,[].slice.call(arguments,0))};(function($,window,undefined){'use strict';var $window=$(window),Modernizr=window.Modernizr;Modernizr.addTest('csstransformspreserve3d',function(){var prop=Modernizr.prefixed('transformStyle');var val='preserve-3d';var computedStyle;if(!prop)return!1;prop=prop.replace(/([A-Z])/g,function(str,m1){return '-'+m1.toLowerCase()}).replace(/^ms-/,'-ms-');Modernizr.testStyles('#modernizr{'+prop+':'+val+';}',function(el,rule){computedStyle=window.getComputedStyle?getComputedStyle(el,null).getPropertyValue(prop):''});return(computedStyle===val)});var $event=$.event,$special,resizeTimeout;$special=$event.special.debouncedresize={setup:function(){$(this).on("resize",$special.handler)},teardown:function(){$(this).off("resize",$special.handler)},handler:function(event,execAsap){var context=this,args=arguments,dispatch=function(){event.type="debouncedresize";$event.dispatch.apply(context,args)};if(resizeTimeout){clearTimeout(resizeTimeout)}
    ...
    this.options.onBeforeFlip(this.current);this.isAnimating=!0;this.$current=this.$items.eq(this.current);if(page!==undefined){this.current=page}
    else if(dir==='next'&&this.options.direction==='ltr'||dir==='prev'&&this.options.direction==='rtl'){if(!this.options.circular&&this.current===this.itemsCount-1){this.end=!0}
    else{this.previous=this.current;this.current=this.current<this.itemsCount-1?this.current+1:0}}
    else if(dir==='prev'&&this.options.direction==='ltr'||dir==='next'&&this.options.direction==='rtl'){if(!this.options.circular&&this.current===0){this.end=!0}
